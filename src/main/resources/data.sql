...
INSERT INTO person(person_id,  user_name, password, email, contact_id)
VALUES (1, 'Bohdan', '12121212', 'bohdan.zsnkevich@ukr.net', 1);
INSERT INTO person(person_id,  user_name, password, email, contact_id)
VALUES (2, 'Bohdan1', '12121212', 'bohdan.zsnkevich@ukr.net2', 2);
INSERT INTO person(person_id,  user_name, password, email, contact_id)
VALUES (3, 'Bohdan2', '12121212', 'bohdan.zsnkevich@ukr.net3', 3);
...
INSERT INTO person(person_id,  user_name, password, email, contact_id)
VALUES (4, 'stanis', '$2a$10$d5LXfYNl7n7DxjL8Ci42lOBiPiSd50400IjWU0AGuUYO8TeF/14de', 'stanis.stanis@ukr.net', 4);
INSERT INTO person(person_id,  user_name, password, email, contact_id)
VALUES (5, 'stanis1', '$2a$10$x8wKe1tpGVJTE4zkHRbDj.OXXblGefWRjjdWw82e5s.m3OjHXGgM6', 'stanis1.stanis1@ukr.net', 5);
